...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 26 2023 г., 08:19
...
(100, '2023-03-03 04:00:00.000000', 1, 1, 1, 94),
(109, '2023-03-03 08:29:10.000000', 1, 2, 1, 123),
(110, '2023-03-04 00:29:32.000000', 1, 2, 1, 163),
(111, '2023-03-05 00:29:47.000000', 1, 2, 1, 184),
(112, '2023-03-06 00:30:55.000000', 1, 2, 1, 193),
(113, '2023-03-07 00:31:08.000000', 1, 2, 1, 201),
(114, '2023-03-08 00:31:20.000000', 1, 2, 1, 224);
...
CREATE TABLE `objects` (
  ...
  `property_property_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `objects` (`object_id`, `description`, `flange_no`, `object_type_id`, `object_name`, `loc_x`, `loc_y`, `property_property_id`) VALUES
(1, 'Куст-2 Скважина-12', '1', 1, 'Скважина-12', '54.97284629297934', '52.14082270933199', NULL),
(2, 'Куст-2 Скважина-13', '1', 1, 'Скважина-13', '54.91044905811192', '52.23297597009278', NULL),
(3, 'Куст-2 Скважина-14', '1', 1, 'Скважина-14', '54.91083733570491', '52.205228548193', NULL),
(4, 'Куст-2 Скважина-15', '1', 1, 'Скважина-15', '54.93375249570987', '52.16320515735165', NULL);

-- --------------------------------------------------------

--
-- Структура таблицы `objects_properties`
--

CREATE TABLE `objects_properties` (
  `object_object_id` int(11) NOT NULL,
  `properties_property_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- --------------------------------------------------------

--
-- Структура таблицы `objects_property`
--

CREATE TABLE `objects_property` (
  `object_object_id` int(11) NOT NULL,
...
--
-- Структура таблицы `object_types_object`
--

CREATE TABLE `object_types_object` (
  `object_type_object_type_id` int(11) NOT NULL,
  `object_object_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `properties` (`property_id`, `object_id`, `path_id`, `property_type_id`, `value_type_id`, `path`) VALUES
(1, 1, 1, 1, 1, 'path_1'),
(2, 2, 2, 1, 1, 'path_2'),
(3, 3, 3, 1, 1, 'path_3'),
(4, 4, 4, 1, 1, 'path_4');
...
(1, 'admin@mai.ru', 'Арслан', '$2a$10$Bwk7dWnZaqp6umF56nZHz.iPWvCUBNz.WeP9tEroWmq4ms.frE4kq', 'Рахмиддинович', '+79999999999', 1, 'Камалов', 'admin'),
...
ALTER TABLE `objects`
  ...
  ADD KEY `FKpb205j8cq8vte6pmo0t4m63yw` (`property_property_id`);

--
-- Индексы таблицы `objects_properties`
--
ALTER TABLE `objects_properties`
  ADD UNIQUE KEY `UK_p1r1d2a811kpjf2f0vdkckan1` (`properties_property_id`),
  ADD KEY `FK8a1utuj4tdtcsbpdpcq9ihvh9` (`object_object_id`);

--
-- Индексы таблицы `objects_property`
--
ALTER TABLE `objects_property`
  ADD UNIQUE KEY `UK_s645styns9pgbuqsuvbg3vto6` (`property_property_id`),
  ADD KEY `FKf6yeiah6neq2pxixty3nt1bss` (`object_object_id`);
...
--
-- Индексы таблицы `object_types_object`
--
ALTER TABLE `object_types_object`
  ADD UNIQUE KEY `UK_jminny6nxdedyyh4e9ycejbel` (`object_object_id`),
  ADD KEY `FKquayh4aepbgv8wd838mb2xuwu` (`object_type_object_type_id`);
...
--
ALTER TABLE `events`
  MODIFY `event_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=115;
...
ALTER TABLE `objects`
  ...
  ADD CONSTRAINT `FKpb205j8cq8vte6pmo0t4m63yw` FOREIGN KEY (`property_property_id`) REFERENCES `properties` (`property_id`);

--
-- Ограничения внешнего ключа таблицы `objects_properties`
--
ALTER TABLE `objects_properties`
  ADD CONSTRAINT `FK8a1utuj4tdtcsbpdpcq9ihvh9` FOREIGN KEY (`object_object_id`) REFERENCES `objects` (`object_id`),
  ADD CONSTRAINT `FKjl2495vnih5pentt277twuvfg` FOREIGN KEY (`properties_property_id`) REFERENCES `properties` (`property_id`);

--
-- Ограничения внешнего ключа таблицы `objects_property`
--
ALTER TABLE `objects_property`
  ADD CONSTRAINT `FK4c1x6tx3w48jf3v2p88tj34gh` FOREIGN KEY (`property_property_id`) REFERENCES `properties` (`property_id`),
  ADD CONSTRAINT `FKf6yeiah6neq2pxixty3nt1bss` FOREIGN KEY (`object_object_id`) REFERENCES `objects` (`object_id`);

--
-- Ограничения внешнего ключа таблицы `object_types_object`
--
ALTER TABLE `object_types_object`
  ADD CONSTRAINT `FKln155xrpda3fesoh7xtvakmup` FOREIGN KEY (`object_object_id`) REFERENCES `objects` (`object_id`),
  ADD CONSTRAINT `FKquayh4aepbgv8wd838mb2xuwu` FOREIGN KEY (`object_type_object_type_id`) REFERENCES `object_types` (`object_type_id`);
